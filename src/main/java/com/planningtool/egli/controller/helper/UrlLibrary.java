public static class UrlLibrary {
    ...
    public static final String GET_PHASE = "/phase-mitarbeiter/{phaseMitarbeiterID}";
    public static final String DELETE_PHASE = "/phase-mitarbeiter/{phaseMitarbeiterID}";
    public static final String SAVE_PHASE = "/phase-mitarbeiter";
    ...
    public static final String GET_STATUS_MITARBEITER = "/status-mitarbeiter/{statusMitarbeiterID}";
    ...
    public static final String GET_STATUS = "/ticket";
    public static final String GET_STATUS_SPECIFIC = "/ticket/{ticketID}";
    public static final String DELETE_STATUS = "/ticket/{ticketID}";
    public static final String SAVE_STATUS = "/ticket";
}